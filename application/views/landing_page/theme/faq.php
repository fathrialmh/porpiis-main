        ...
        <div class="card-header" role="tab" id="headingFour">
          <h4 class="card-title">
            <a class="collapsed" role="button" data-toggle="collapse" href="#collapseFour"
              ...
              Apa Saja Syarat dan Ketentuan Untuk Mengikuti Event?
            </a>
          </h4>
        </div>
        ...
        <div class="card-header" role="tab" id="headingFive">
          <h4 class="card-title">
            <a class="collapsed" role="button" data-toggle="collapse" href="#collapseFive"
              ...
              Bagaimana Proses Pembayaran Untuk Mengikuti Event?
            </a>
          </h4>
        </div>
...
<section>
  <div class="row">
    <div class="col-md mb-4 d-flex justify-content-center">
      <a href="https://d1fdloi71mui9q.cloudfront.net/a5joPG5lRM6VsMDANVgR_Proposal%20Peserta%20POR%20PIIS-2.pdf"><button class="btn-style-one">Download Petunjuk Pelaksanaan</button></a>
    </div>
  </div>
</section>