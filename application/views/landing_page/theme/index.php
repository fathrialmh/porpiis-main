  ...
  <div class="container">
    <div class="cta-block row no-gutters">
      ...
      <div class="col-lg-4 col-md-6 top-doctor item">
        ...
        <h2>About PORPIIS</h2>
        <p>POR PIIS Merupakan Pekan Olahraga yang diadakan oleh Permata Insani. Tema kegiatan tahun ini adalah POR PIIS 2023: “Tunjukkan Sportivitas, Jadilah Pemenang”. </p>
        <a href="about" class="btn btn-main">Read more</a>
      </div>
        ...
        <div class="col-md-12">
          ...
          <div class="tab-content" id="aboutTab">
            <div class="service-box tab-pane fade show active" id="dormitory">
              <div class="row">
                <div class="col-lg-6">
                  <img loading="lazy" class="img-fluid" src="<?= base_url(); ?>assets/img/images/services/futsal.jpg" alt="service-image">
                </div>
                <div class="col-lg-6">
                  <div class="contents">
                    ...
                    <div class="text">
                      ...
                      Tujuan dari permainan adalah untuk memasukkan bola ke gawang lawan sebanyak, dengan memanipulasi bola dengan kaki.</p>
                    </div>
                    <ul class="content-list">
                      <h5><span>Persyaratan :</span></h5>
                      <li>
                        <i class="far fa-dot-circle"></i>Sehat jasmani dan rohani
                      </li>
                      <li>
                        <i class="far fa-dot-circle"></i>Masih berstatus siswa sekolah aktif</li>
                      <li>
                        <i class="far fa-dot-circle"></i>Mematuhi syarat & ketentuan yang berlaku</li>
                        <h6><br>Biaya Pendaftaran: Rp. 300.000</h6>
                    </ul>
                    <a href="pendaftaran" class="btn-style-one">Register Now</a>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-6">
                  <div class="contents">
                    ...
                    <a href="services.html" class="btn-style-one" style="border-radius=10px;">Read more</a>
                  </div>
                </div>
              </div>
            </div>
