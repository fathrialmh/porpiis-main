...
<head>
  ...
  <!-- Favicon -->
  <link rel="shortcut icon" type="image/x-icon" href="<?= base_url(); ?>assets/img/images/favicon.png" />

	<!-- CSS
		================================================== -->
	<!-- Fontawesome Icon font -->
	<link rel="stylesheet" href="<?= base_url(); ?>assets/vendor/themefisher-font/style.css">
	<!-- bootstrap.min css -->
	<link rel="stylesheet" href="<?= base_url(); ?>assets/vendor/bootstrap/bootstrap.min.css">
	<!-- Animate.css -->
	<link rel="stylesheet" href="<?= base_url(); ?>assets/vendor/animate-css/animate.css">
	<!-- Magnific popup css -->
	<link rel="stylesheet" href="<?= base_url(); ?>assets/vendor/magnific-popup/dist/magnific-popup.css">
	<!-- Slick Carousel -->
...
==================================== -->
 ...
 <section class="hero-area overlay" style="background-image: url('<?= base_url(); ?>assets/img/images/banner/pubg.png');">
...
<section class="section about-2 padding-0 bg-dark" id="about">
	<div class="container-fluid p-0">
		<div class="row no-gutters align-items-center">
			<div class="col-lg-6">
				<img class="img-fluid" src="<?= base_url(); ?>assets/img/images/about/about-business-man.jpg" alt="">
			</div>
			<div class="col-lg-6">
		...
		<div class="row">
			<div class="col-md-6">
				...
				<p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis magni explicabo cum aperiam recusandae
					...
					tempora!</p>
				<img class="img-fluid" src="<?= base_url(); ?>assets/img/images/about/company-growth.png" alt="">
			</div>
		...
		<div class="row mx-auto filtr-container">
			<div class="filtr-item col-lg-4 col-md-6" data-category="development">
				<div class="portfolio-block">
					<img src="<?= base_url(); ?>assets/img/images/portfolio/portfolio-1.jpg" alt="">
					<div class="caption">
						<a class="search-icon image-popup" data-effect="mfp-with-zoom" href="<?= base_url(); ?>assets/img/images/portfolio/portfolio-1.jpg"
			...
			<div class="filtr-item col-lg-4 col-md-6" data-category="design">
				<div class="portfolio-block">
					<img src="<?= base_url(); ?>assets/img/images/portfolio/portfolio-2.jpg" alt="">
					<div class="caption">
						<a class="search-icon image-popup" data-effect="mfp-with-zoom" href="<?= base_url(); ?>assets/img/images/portfolio/portfolio-2.jpg"
							data-lightbox="image-1">
							<i class="tf-ion-android-search"></i>
						</a>
			...
			<div class="filtr-item col-lg-4 col-md-6" data-category="design, development">
				<div class="portfolio-block">
					<img src="<?= base_url(); ?>assets/img/images/portfolio/portfolio-3.jpg" alt="">
					<div class="caption">
						<a class="search-icon image-popup" data-effect="mfp-with-zoom" href="<?= base_url(); ?>assets/img/images/portfolio/portfolio-3.jpg"
							data-lightbox="image-1">
							<i class="tf-ion-android-search"></i>
						</a>
			...
			<div class="filtr-item col-lg-4 col-md-6" data-category="photography, development">
				<div class="portfolio-block">
					<img src="<?= base_url(); ?>assets/img/images/portfolio/portfolio-4.jpg" alt="">
					<div class="caption">
						<a class="search-icon image-popup" data-effect="mfp-with-zoom" href="<?= base_url(); ?>assets/img/images/portfolio/portfolio-4.jpg"
							data-lightbox="image-1">
							<i class="tf-ion-android-search"></i>
						</a>
			...
			<div class="filtr-item col-lg-4 col-md-6" data-category="design">
				<div class="portfolio-block">
					<img src="<?= base_url(); ?>assets/img/images/portfolio/portfolio-5.jpg" alt="">
					<div class="caption">
						<a class="search-icon image-popup" data-effect="mfp-with-zoom" href="<?= base_url(); ?>assets/img/images/portfolio/portfolio-5.jpg"
							data-lightbox="image-1">
							<i class="tf-ion-android-search"></i>
						</a>
			...
			<div class="filtr-item col-lg-4 col-md-6" data-category="photography">
				<div class="portfolio-block">
					<img src="<?= base_url(); ?>assets/img/images/portfolio/portfolio-6.jpg" alt="">
					<div class="caption">
						<a class="search-icon image-popup" data-effect="mfp-with-zoom" href="<?= base_url(); ?>assets/img/images/portfolio/portfolio-6.jpg"
							data-lightbox="image-1">
							<i class="tf-ion-android-search"></i>
						</a>
						<h4><a href="">Tag Design</a></h4>
			...
			<div class="filtr-item col-lg-4 col-md-6" data-category="design">
				<div class="portfolio-block">
					<img src="<?= base_url(); ?>assets/img/images/portfolio/portfolio-7.jpg" alt="">
					<div class="caption">
						<a class="search-icon image-popup" data-effect="mfp-with-zoom" href="<?= base_url(); ?>assets/img/images/portfolio/portfolio-7.jpg"
							data-lightbox="image-1">
							<i class="tf-ion-android-search"></i>
						</a>
			...
			<div class="filtr-item col-lg-4 col-md-6" data-category="design">
				<div class="portfolio-block">
					<img src="<?= base_url(); ?>assets/img/images/portfolio/portfolio-8.jpg" alt="">
					<div class="caption">
						<a class="search-icon image-popup" data-effect="mfp-with-zoom" href="<?= base_url(); ?>assets/img/images/portfolio/portfolio-8.jpg"
							data-lightbox="image-1">
							<i class="tf-ion-android-search"></i>
						</a>
		...
		<div class="row">
			...
			<div class="col-lg-3 col-md-6 wow fadeIn" data-wow-duration="500ms">
				<div class="team-member">
					<div class="member-photo">
						<!-- member photo -->
						<img class="img-fluid" src="<?= base_url(); ?>assets/img/images/team/team-1.jpg" alt="Meghna">
						<!-- /member photo -->
			...
			<div class="col-lg-3 col-md-6 wow fadeIn" data-wow-duration="500ms" data-wow-delay="200ms">
				<div class="team-member">
					<div class="member-photo">
						<!-- member photo -->
						<img class="img-fluid" src="<?= base_url(); ?>assets/img/images/team/team-2.jpg" alt="Meghna">
						<!-- /member photo -->
			...
			<div class="col-lg-3 col-md-6 wow fadeIn" data-wow-duration="500ms" data-wow-delay="400ms">
				<div class="team-member">
					<div class="member-photo">
						<!-- member photo -->
						<img class="img-fluid" src="<?= base_url(); ?>assets/img/images/team/team-3.jpg" alt="Meghna">
						<!-- /member photo -->
			...
			<div class="col-lg-3 col-md-6 wow fadeIn" data-wow-duration="500ms" data-wow-delay="600ms">
				<div class="team-member">
					<div class="member-photo">
						<!-- member photo -->
						<img class="img-fluid" src="<?= base_url(); ?>assets/img/images/team/team-4.jpg" alt="Meghna">
						<!-- /member photo -->
				...
				<div id="testimonials" class="wow fadeInUp" data-wow-duration="500ms" data-wow-delay="100ms">
					...
					<div class="item text-center">
						...
						<div class="client-thumb">
							<img src="<?= base_url(); ?>assets/img/images/team/client-1.jpg" class="img-fluid" alt="Meghna">
						</div>
						<!-- /client photo -->
					...
					<div class="item text-center">
						...
						<!-- client photo -->
						<div class="client-thumb">
							<img src="<?= base_url(); ?>assets/img/images/team/client-2.jpg" class="img-fluid" alt="Meghna">
						</div>
						<!-- /client photo -->
	...
	<div class="container">
		<div class="row">
			...
			<article class="col-lg-4 col-md-6 wow fadeInUp" data-wow-duration="500ms">
				<div class="post-block">
					<div class="media-wrapper">
						<img src="<?= base_url(); ?>assets/img/images/blog/blog-post-1.jpg" alt="amazing caves coverimage" class="img-fluid">
					</div>
					<div class="content">
			...
			<article class="col-lg-4 col-md-6 wow fadeInUp" data-wow-duration="500ms" data-wow-delay="200ms">
				<div class="post-block">
					<div id="gallery-post" class="media-wrapper">
						<div class="item">
							<img src="<?= base_url(); ?>assets/img/images/blog/blog-post-1.jpg" alt="blog post" class="img-fluid">
						</div>
						<div class="item">
							<img src="<?= base_url(); ?>assets/img/images/blog/blog-post-3.jpg" alt="blog post" class="img-fluid">
						</div>
						<div class="item">
							<img src="<?= base_url(); ?>assets/img/images/blog/blog-post-2.jpg" alt="blog post | Meghna" class="img-fluid">
						</div>
					</div>
			...
			<article class="col-lg-4 col-md-6 wow fadeInUp" data-wow-duration="500ms" data-wow-delay="400ms">
				<div class="post-block">
					<div class="media-wrapper">
						<img src="<?= base_url(); ?>assets/img/images/blog/blog-post-6.jpg" alt="amazing caves coverimage" class="img-fluid">
					</div>
...
<footer id="footer" class="bg-one">
	...
	<!-- Portfolio Filtering -->
	<script src="<?= base_url(); ?>assets/vendor/filterzr/jquery.filterizr.min.js"></script>
	<!-- Magnific popup -->
	<script src="<?= base_url(); ?>assets/vendor/magnific-popup/dist/jquery.magnific-popup.min.js"></script>
	<!-- Google Map API -->
	<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAgeuuDfRlweIs7D6uo4wdIHVvJ0LonQ6g"></script>
	<script src="<?= base_url(); ?>assets/vendor/google-map/gmap.js"></script>
	<!-- wow.min Script -->
